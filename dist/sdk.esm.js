...
import ISunPair from '@pancakeswap-libs/pancake-swap-core/build/ISunPair.json';
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new Contract(address, ISunPair.abi, provider).getReserves()).then(function (_ref) {
