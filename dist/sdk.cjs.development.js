...
var ISunPair = _interopDefault(require('@pancakeswap-libs/pancake-swap-core/build/ISunPair.json'));
...
var FACTORY_ADDRESS = '0xBa99e6F814ACBE66a6ad353798748aFC662d9534';
/** change  */

var INIT_CODE_HASH = '0xe6c9b5778aa578689587c301fc4d20f8363cd4a6b1e4577f2214ebf5578b4bfa';
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'Sun-LP', 'Sun LPs');
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, ISunPair.abi, provider).getReserves()).then(function (_ref) {
